...
cat autoenum/aggr_scan/raw/first_pass | grep "script results" | tee autoenum/aggr_scan/ports_and_services/script_output; cat autoenum/aggr_scan/raw/first_pass | grep "|" | sed '$d' | tee -a autoenum/aggr_scan/ports_and_services/script_output
