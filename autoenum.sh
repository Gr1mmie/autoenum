...
#$nmap_aggr | tee -a autoenum/aggr_scan/raw/first_pass & $nmap_aggr -oX autoenum/aggr_scan/raw/nmap_out.xml
nmap -sV $IP -oX autoenum/aggr_scan/raw/nmap_out.xml & $nmap_aggr -oN autoenum/aggr_scan/raw/first_pass;
...
#$nmap_aggr -oX autoenum/aggr_scan/raw/nmap_out.xml -> only needs services
...
if [ -s 'autoenum/aggr_scan/raw/smb_found' ]
	then
		...
		nmap --script=smb-check-vulns.nse --script-args=unsafe=1 -p 139,445 $IP -oN autoenum/loot/smb/general_vulns;sleep 3
		nmap --script=smb-enum-shares.nse --script-args=unsafe=1 -p 139,445 $IP -oN autoenum/loot/smb/enum_shares;sleep 3
		nmap --script=smb-enum-users.nse --script-args=unsafe=1 -p 139,445 $IP -oN autoenum/loot/smb/enum_users;sleep 3
		nmap --script=smb-vuln-ms17-010.nse --script-args=unsafe=1 -p 139,445 $IP -oN autoenum/loot/smb/eternalblue;sleep 3
