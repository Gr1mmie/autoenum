			...
			then
				...
				for port in $(cat autoenum/loot/http/ports)
					do
						...
						gobuster dir -re -t 25 -w /usr/share/wordlists/dirb/common.txt -o autoenum/loot/http/dirs/raw &
						for dir in $(cat autoenum/loot/http/dir); do gobuster dir -re -t 25 -w /usr/share/wordlists/dirb/common.txt -o "autoenum/loot/http/dirs/$dir" &;done
					done
